...
const TimePicker = (props) => {
    ...
    const [time, setTime] = useNamedState("time", "12:00");
    ...
    const updateTime = () => {
        ...
        if (isValid) {
            ...
            inputRef.current.value = formatTime()
        }
        else {
    ...
    const handleBlur = (e) => {
        ...
        //console.log("blur run", validateHhMm(e.target.value, timeFormat));
    }
    ...
    const newTime = useMemo(() => props.time ? props.time : "12:00 AM", [props.time]);
    ...
    return (
        <div className="form-outline"  >
            ...
            <button onClick={() => setShowTimePicker(!showTimePicker)} id="timepicker-toggle-371513" type="button" className="timepicker-toggle-button"><FaRegClock /></button>
                            ...
                            <div className="row justify-content-end g-0">
                                {timeFormat === 12 && (
                                    <div className="col-5   d-flex justify-content-center align-items-center position-relative  ">
                                        ...
                                        <button className="timepicker-current" style={{ fontSize: styling.timepickerCurrent_fontSize }}>{period}</button>
                                        <div className="timepicker_wrapper_icon " style={{ bottom: styling.icondown_bottom }} >
